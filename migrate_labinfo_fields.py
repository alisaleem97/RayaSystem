...
def migrate():
    ...
    if "welcome_template_name" not in columns:
        cursor.execute("ALTER TABLE labinfo ADD COLUMN welcome_template_name TEXT DEFAULT NULL")
        print("Added welcome_template_name column to labinfo table")
    else:
        print("welcome_template_name column already exists")
