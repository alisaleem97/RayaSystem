        ...
        if log.new_values:
            try:
                ...
                if safe_action == "PRINT":
                    ...
                    if explicit_action and "Added" in explicit_action:
                        action_type = "Test Added"
                    else:
                        action_type = "Profile Update"
                elif safe_action == "DELETE" and safe_table == "patient":
                    if explicit_action and "Removed" in explicit_action:
                        action_type = "Test Removed"
                    else:
                        action_type = "Patient Deleted"
                elif safe_table == "order":
                    if explicit_action:
                        if "Removed" in explicit_action:
                            action_type = "Test Removed"
                        elif "Double" in explicit_action:
